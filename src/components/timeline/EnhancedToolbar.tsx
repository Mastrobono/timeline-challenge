      ...
      <div className="flex flex-1 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-gray-800 rounded-md border border-white/10 transition-colors"
          ...
          <button
            onClick={goToToday}
            className="px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-gray-800 rounded-md border border-white/10 transition-colors"
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center bg-gray-800 rounded-md border border-white/10">
              ...
              <span className="px-3 py-1 text-sm font-medium text-white min-w-[3rem] text-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2 bg-gray-800 text-white border border-white/10 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
